...
public class ResourcesExceptionHandler {
	...
	@ExceptionHandler(AuthenticacaoExcecao.class)
	public ResponseEntity<StandardError> authenticacao(AuthenticacaoExcecao e, HttpServletRequest request) {

		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Autenticacao falhou",e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.INTERNAL_SERVER_ERROR.value(), "Autorização negada",e.getMessage(),request.getRequestURI());
